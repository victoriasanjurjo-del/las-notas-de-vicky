...
def obtener_noticias_futbol():
    ...
    carpeta_destino = "noticias/futbol-argentino"
    ...
    # Armamos la ruta completa (ej. futbol-argentino/2026-07-14.json)
    ruta_completa = os.path.join(carpeta_destino, nombre_archivo)

    # 2. Búsqueda y filtrado: priorizamos fútbol argentino y la liga local
    query = 'fútbol argentino OR "liga profesional" -"política" -"economía" -"internacional"'
    ...
    print(f"¡Listo! Archivo de fútbol argentino generado en: {ruta_completa}")

if __name__ == "__main__":
    obtener_noticias_futbol()