...
def obtener_noticias_internacionales():
    # 1. Definimos la carpeta y el nombre del archivo con la fecha de hoy
    carpeta_destino = "noticias/politica-internacional"
    ...
    # Armamos la ruta completa (ej. politica-internacional/2026-07-14.json)
    ruta_completa = os.path.join(carpeta_destino, nombre_archivo)

    # 2. Búsqueda y filtrado: priorizamos política internacional, alejamos noticias locales
    query = 'política internacional -"argentina" -"economía local" -"deportes"'
    ...
    print(f"¡Listo! Archivo de política internacional generado en: {ruta_completa}")

if __name__ == "__main__":
    obtener_noticias_internacionales()