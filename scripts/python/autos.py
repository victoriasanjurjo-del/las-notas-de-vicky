...
def obtener_noticias_autos():
    ...
    # Armamos la ruta completa (ej. autos/2026-07-14.json)
    ruta_completa = os.path.join(carpeta_destino, nombre_archivo)

    # 2. Búsqueda y filtrado: priorizamos autos y sector automotriz
    query = 'autos OR automotriz OR "industria automotriz" -"política" -"fútbol" -"elecciones"'
    ...
    print(f"¡Listo! Archivo de autos generado en: {ruta_completa}")

if __name__ == "__main__":
    obtener_noticias_autos()