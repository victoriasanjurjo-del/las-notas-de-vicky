...
def obtener_noticias_motos():
    ...
    # Armamos la ruta completa (ej. noticias/motos/2026-07-14.json)
    ruta_completa = os.path.join(carpeta_destino, nombre_archivo)

    # 2. Búsqueda y filtrado: priorizamos motos y motociclismo, alejamos autos y otros temas
    query = 'motos OR motociclismo OR motocicletas -"autos" -"política" -"fútbol" -"economía"'
    ...
    print(f"¡Listo! Archivo de motos generado en: {ruta_completa}")

if __name__ == "__main__":
    obtener_noticias_motos()